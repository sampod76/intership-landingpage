            ...
            <div className='lggg:w-[20rem] lggg:h-[29rem] md:w-[17rem] md:h-[23rem] lg:w-[20rem] lg:h-[32rem]   bg-[#7065F0] rounded-2xl flex flex-col justify-between lg:px-6 lg:py-7 py-2 px-3 text-white ' >
                    ...
                    <div>
                        ...
                        <div className='space-y-3  px-2'>
                            ...
                            <div className='flex gap-3 ml-1 items-center'>
                                ...
                                <h1 className='font-semibold'>brucekent@gmail.com</h1>
                            </div>
                            <div className='flex gap-3 ml-1 items-center'>
                                <h1>
                                ...
                                <h1 className=' font-semibold'> Los Angeles, USA</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div className='flex justify-around  -ml-1 mb-2 pb-2 '>
                    <div className='space-y-3 '>
                        <h1 className='font-bold '>Approved Businesses</h1>
                        <h1 className=''>5</h1>
                    </div>
